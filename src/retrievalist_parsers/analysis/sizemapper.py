...
class PivotLinearMapper(SizeMapper):
    def __init__(self, style_info: StyleDistribution):
        ...
        right_step = (right_span / 2.0) * 0.5
        left_step = (left_span / 2.0) * 0.5

        b0, b1 = (
            style_info.min_found_size + left_step,
            style_info.min_found_size + left_step * 2,
        )
